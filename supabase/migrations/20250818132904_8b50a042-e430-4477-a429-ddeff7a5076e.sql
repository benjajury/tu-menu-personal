-- Crear función de recomendaciones de menu items
      ...
      (
        ...
        CASE 
          WHEN tipo_carne_param IS NOT NULL 
               AND tipo_carne IS NOT NULL 
               AND tipo_carne = ANY(tipo_carne_param) 
          THEN 40 
          ELSE 0 
        END +
        ...
        CASE 
          WHEN drink_type_param IS NOT NULL 
               ...
               AND drink_type = ANY(drink_type_param) 
          THEN 20 
          ELSE 0 
        END +
        ...
        CASE 
          WHEN sophistication_param IS NOT NULL 
               AND sophistication_level IS NOT NULL 
               AND sophistication_level = ANY(sophistication_param) 
          THEN 10 
          ELSE 0 
        END +
        ...
        CASE 
          ...
          THEN -(ABS(price - ((budget_min_param + budget_max_param) / 2)) / 1000)
          ELSE 0
        END +
