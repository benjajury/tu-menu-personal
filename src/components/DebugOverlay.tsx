...
export default function DebugOverlay({ menuItems, answers, recommended }: any) {
  ...
  return (
    <div style={{
      ...
      background:'rgba(0,0,0,.8)', color:'#fff', padding:12, borderRadius:12,
      maxWidth: 360, fontSize:12, lineHeight:1.2, overflow:'auto', maxHeight: '60vh'
    }}>
      <div style={{opacity:.8, fontWeight:600}}>DEBUG</div>
